...
LANDCOVER_RASTER_PATHS = {
    ...
    'worldclim_esa_2015': (f"{LANDUSE_DIR}/ESACCI-LC-L4-LCCS-Map-300m-P1Y-2015-v2.0.7_md5_1254d25f937e6d9bdee5779d377c5aa4", 255),
...
def aggregate_to_database(
    ...
    base_ref_wkt = base_raster_info['projection_wkt']
    wgs84_sr = osr.SpatialReference()
    wgs84_sr.ImportFromEPSG(4326)
